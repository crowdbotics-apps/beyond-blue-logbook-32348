...
## Project Structure
    ...
    ├── beyond_blue_logbook_32348  # Django project configurations
...
1. Clone this repo and `cd beyond_blue_logbook_32348`
...
2. Clone this repo and `cd beyond_blue_logbook_32348`
